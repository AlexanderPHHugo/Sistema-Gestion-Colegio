    ...
    <div class="app-layout">
        ...
        <main class="app-content">
            ...
            <div class="container">
                ...
                <form class="form-card" action="index.php?modulo=profesor&accion=actualizar" method="POST">

                    <!-- El ID viaja oculto para saber que profesor se actualiza. -->
                    ...
                    <div class="form-group">
                        ...
                        <input
                            type="text"
                            name="especialidad"
                            value="<?php echo h($datos["especialidad"] ?? ""); ?>"
                            required
                            maxlength="100">
                    </div>
                    ...
                    <div class="form-actions">
                        ...
                        <a class="button button-secondary" href="index.php?modulo=profesor">Cancelar</a>
                    </div>
